"""
agents.spine.citation_guard
===========================

Deterministic citation / confidence tier guard — shared across all agents.

Promoted from agents.atlas.citation_guard per ADR-0001 (D0.3).
